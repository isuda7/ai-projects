...
const TypographyGuidePage = () => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <section className={styles.section}>
        <h2 className={styles.title_h2}>2. Title (강조용 14~18px)</h2>
        <div>
      ...
      <section className={styles.section}>
        <h2 className={styles.title_h2}>3. Body (본문용 14~18px)</h2>
        <div>
      ...
      <section className={styles.section}>
        <h2 className={styles.title_h2}>4. Label (라벨용 10~13px)</h2>
        <div>
