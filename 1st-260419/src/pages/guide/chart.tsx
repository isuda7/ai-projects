      ...
      <GuideSection title="2. Basic Usage">
        ...
        <div className={styles.sub_section}>
          ...
          <div className={styles.preview}>
              ...
              <div className="w-full max-w-lg border p-4 rounded-lg bg-white shadow-sm"><h3 className="font-semibold mb-4">Monthly Traffic (Bar)</h3><div className="h-[250px] w-full"><ChartContainer config={chartConfig} className="min-h-[200px] w-full"><ResponsiveContainer width="100%" height="100%"><BarChart data={chartData}><CartesianGrid strokeDasharray="3 3" vertical={false}/><XAxis dataKey="month" /><YAxis /><ChartTooltip content={<ChartTooltipContent />} /><Bar dataKey="desktop" fill="var(--color-desktop)" radius={[4, 4, 0, 0]} /><Bar dataKey="mobile" fill="var(--color-mobile)" radius={[4, 4, 0, 0]} /></BarChart></ResponsiveContainer></ChartContainer></div></div>
            </div>
          <div className={styles.code_view}>
            <pre>
              <code>
      ...
      <GuideSection title="3. Variants & States">
        ...
        <div className={styles.sub_section}>
          ...
          <div className={styles.preview}>
              ...
              <div className="w-full max-w-lg border p-4 rounded-lg bg-white shadow-sm"><h3 className="font-semibold mb-4">Monthly Trend (Line)</h3><div className="h-[250px] w-full"><ChartContainer config={chartConfig} className="min-h-[200px] w-full"><ResponsiveContainer width="100%" height="100%"><LineChart data={chartData} margin={{ top: 5, right: 20, left: 20, bottom: 5 }}><CartesianGrid strokeDasharray="3 3" vertical={false}/><XAxis dataKey="month" /><YAxis /><ChartTooltip content={<ChartTooltipContent />} /><Line type="monotone" dataKey="desktop" stroke="var(--color-desktop)" strokeWidth={3} dot={{r: 4}} /><Line type="monotone" dataKey="mobile" stroke="var(--color-mobile)" strokeWidth={3} dot={{r: 4}} /></LineChart></ResponsiveContainer></ChartContainer></div></div>
            </div>
          <div className={styles.code_view}>
            <pre>
              <code>
