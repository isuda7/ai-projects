...
const UtilityBlock = ({ title, classNameText, children, description }: any) => (
  <div style={{ marginBottom: '24px', padding: '20px', backgroundColor: '#f9fafb', borderRadius: '8px', border: '1px solid #e5e7eb' }}>
    <h4 className={styles.title_h4} style={{ marginBottom: '8px' }}>
      {title} <span style={{ color: '#2563eb', fontSize: '14px', marginLeft: '8px', fontWeight: 'bold' }}>.{classNameText}</span>
    </h4>
        ...
        <div className={styles.sub_section}>
          <UtilityBlock title="Percentage Width (%)" classNameText="w-{size}p" description="부모 요소에 비례하는 퍼센트 너비입니다.">
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <div style={{ width: '100%', padding: '8px', backgroundColor: '#e0f2f1', textAlign: 'center', borderRadius: '4px', color: '#00796b', fontSize: '12px' }}>w-100p (100%)</div>
              <div style={{ width: '80%', padding: '8px', backgroundColor: '#e0f2f1', textAlign: 'center', borderRadius: '4px', color: '#00796b', fontSize: '12px' }}>w-80p (80%)</div>
              <div style={{ width: '50%', padding: '8px', backgroundColor: '#e0f2f1', textAlign: 'center', borderRadius: '4px', color: '#00796b', fontSize: '12px' }}>w-50p (50%)</div>
              <div style={{ width: '30%', padding: '8px', backgroundColor: '#e0f2f1', textAlign: 'center', borderRadius: '4px', color: '#00796b', fontSize: '12px' }}>w-30p (30%)</div>
            </div>
          </UtilityBlock>

          <UtilityBlock title="Fixed Width (px)" classNameText="w-{size}" description="지정된 스케일에 따른 고정 픽셀 너비입니다.">
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <div style={{ width: '400px', padding: '8px', backgroundColor: '#e8eaf6', textAlign: 'center', borderRadius: '4px', color: '#303f9f', fontSize: '12px' }}>w-400 (400px)</div>
              <div style={{ width: '240px', padding: '8px', backgroundColor: '#e8eaf6', textAlign: 'center', borderRadius: '4px', color: '#303f9f', fontSize: '12px' }}>w-240 (240px)</div>
              <div style={{ width: '160px', padding: '8px', backgroundColor: '#e8eaf6', textAlign: 'center', borderRadius: '4px', color: '#303f9f', fontSize: '12px' }}>w-160 (160px)</div>
              <div style={{ width: '100px', padding: '8px', backgroundColor: '#e8eaf6', textAlign: 'center', borderRadius: '4px', color: '#303f9f', fontSize: '12px' }}>w-100 (100px)</div>
              <div style={{ width: '40px', padding: '8px', backgroundColor: '#e8eaf6', textAlign: 'center', borderRadius: '4px', color: '#303f9f', fontSize: '12px' }}>w-40 (40px)</div>
            </div>
          </UtilityBlock>
        </div>
      </GuideSection>
        ...
        <div className={styles.sub_section}>
          <UtilityBlock title="Grid Container & Items" classNameText="grid, col, row" description="부모 요소에 grid를 선언하고, 자식 요소에 col, row를 배치합니다.">
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px' }}>
              <div style={{ padding: '16px', backgroundColor: '#e8eaf6', textAlign: 'center', borderRadius: '4px', color: '#303f9f' }}>.col</div>
              <div style={{ padding: '16px', backgroundColor: '#e8eaf6', textAlign: 'center', borderRadius: '4px', color: '#303f9f' }}>.col</div>
              <div style={{ padding: '16px', backgroundColor: '#e8eaf6', textAlign: 'center', borderRadius: '4px', color: '#303f9f' }}>.col</div>
            </div>
            <div style={{ display: 'grid', gridTemplateRows: 'auto auto', gap: '8px', marginTop: '12px' }}>
               <div style={{ padding: '8px', backgroundColor: '#f3e5f5', textAlign: 'center', borderRadius: '4px', color: '#512da8' }}>.row</div>
               <div style={{ padding: '8px', backgroundColor: '#f3e5f5', textAlign: 'center', borderRadius: '4px', color: '#512da8' }}>.row</div>
            </div>
          </UtilityBlock>
        </div>
      ...
      <GuideSection title="3. Alignment">
        ...
        <div className={styles.sub_section}>
          <UtilityBlock title="Top Align" classNameText="align-t" description="위쪽으로 정렬합니다.">
            <div style={{ display: 'flex', alignItems: 'flex-start', height: '60px', backgroundColor: '#fef2f2', padding: '8px', color: '#b91c1c' }}>
              Top Aligned Content
            </div>
          </UtilityBlock>

          <UtilityBlock title="Bottom Align" classNameText="align-b" description="아래쪽으로 정렬합니다.">
            <div style={{ display: 'flex', alignItems: 'flex-end', height: '60px', backgroundColor: '#fef2f2', padding: '8px', color: '#b91c1c' }}>
              Bottom Aligned Content
            </div>
          </UtilityBlock>

          <UtilityBlock title="Middle / Center Align" classNameText="align-m" description="수직 및 수평 중앙으로 정렬합니다.">
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '60px', backgroundColor: '#fef2f2', padding: '8px', color: '#b91c1c' }}>
              Middle Aligned Content
            </div>
          </UtilityBlock>

          <UtilityBlock title="Left Align" classNameText="align-l" description="왼쪽으로 텍스트를 정렬합니다.">
            <div style={{ textAlign: 'left', backgroundColor: '#eff6ff', padding: '16px', color: '#1d4ed8' }}>
              Left Aligned Text
            </div>
          </UtilityBlock>

          <UtilityBlock title="Right Align" classNameText="align-r" description="오른쪽으로 텍스트를 정렬합니다.">
            <div style={{ textAlign: 'right', backgroundColor: '#eff6ff', padding: '16px', color: '#1d4ed8' }}>
              Right Aligned Text
            </div>
          </UtilityBlock>
        </div>
