...
### 가이드 페이지 개별 구성 스펙 (guide/component/carousel.html)

1. Overview & Specs
2. Basic Usage
  - 2.1. Default State
3. Variants & States
  - 3.1. Multiple Items Per View
  - 3.2. Outside Navigation Buttons
  - 3.3. Autoplay & Play/Pause Controls
